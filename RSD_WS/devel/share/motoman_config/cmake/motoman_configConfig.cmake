...
if("TRUE" STREQUAL "TRUE")
  set(motoman_config_SOURCE_PREFIX /home/shadic/RSD_WS/src/motoman_config)
  set(motoman_config_DEVEL_PREFIX /home/shadic/RSD_WS/devel)
  ...
  set(motoman_config_INSTALL_PREFIX /home/shadic/RSD_WS/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://moveit.ros.org/ " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'slimshady <adnanamir010@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'motoman_config' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'motoman_config' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shadic/RSD_WS/src/motoman_config/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT motoman_config_NUM_DUMMY_TARGETS)
      set(motoman_config_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::motoman_config::wrapped-linker-option${motoman_config_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR motoman_config_NUM_DUMMY_TARGETS "${motoman_config_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::motoman_config::wrapped-linker-option${motoman_config_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND motoman_config_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shadic/RSD_WS/devel/lib;/home/shadic/RSD_WS/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${motoman_config_dep}_FOUND)
      find_package(${motoman_config_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${motoman_config_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
